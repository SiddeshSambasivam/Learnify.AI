                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-4" style={{'marginTop':'1vh'}}>                            
                            ...
                            {courseNames}
                            <h1 className="list-group-item list-group-item-warning" style={{"marginTop":'5vh'}}>
                                Lectures
                            </h1>
                            {renderLectures}
                            {searchShow?
                            <React.Fragment>
                                <h1 className="list-group-item list-group-item-success" style={{"marginTop":'8vh'}}>
                                    Search Topic
                                </h1>
                                <div class="input-group mb-3" >
                                    <input type="text" class="form-control" placeholder="Enter topic" aria-label="Recipient's username" aria-describedby="button-addon2" />
