                ...
                <div className="col-5">
                  <p>
                    <h2 style={{ fontWeight: "bold" }}>
                      Magnify, Identify, Simplify
                    </h2>
                    <br />
                    <b>
                      Do you want to see which topics in the your lecture notes
                      are connected?
                    </b>
                    <br />
                    <br />
                    Learnify.ai helps you to visualize your notes in a knowledge
                    graph and helps you to revise topics based on the amount of
                    study time available for a given course.
                    <br />
                    <br />
                    This would help you prepare more efficiently during
                    examinations as well as better visualize the content they
                    need to study.
                  </p>
                </div>
